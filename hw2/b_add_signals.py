...
class Window(QtWidgets.QWidget):
    ...
    def initSignals(self) -> None:
        ...
        self.pushButtonPlainTextEdit.clicked.connect(lambda: self.plainTextEditLog.setPlainText(self.plainTextEdit.toPlainText()))
        self.pushButtonSpinBox.clicked.connect(lambda: self.plainTextEditLog.setPlainText(str(self.spinBox.value())))
        self.pushButtonDoubleSpinBox.clicked.connect(lambda: self.plainTextEditLog.setPlainText(str(self.doubleSpinBox.value())))
        self.pushButtonTimeEdit.clicked.connect(lambda: self.plainTextEditLog.setPlainText(str(self.timeEdit.time())))
        self.pushButtonDateTimeEdit.clicked.connect(lambda: self.plainTextEditLog.setPlainText(str(self.timeEdit.dateTime())))
        ...
        self.dateTimeEdit.dateTimeChanged.connect(lambda x: self.plainTextEditLog.setPlainText(str(x)))
